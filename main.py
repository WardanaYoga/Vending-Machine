...
def check_button():
    ...
    if io.input(pushbutton_putih) == io.HIGH:
        if not hasattr(check_button, "last_putih_press") or time.time() - check_button.last_putih_press > 0.5:  # debounce
            check_button.last_putih_press = time.time()
            # Add functionality for white button here
            print("White button pressed")  # Debugging
            print("Membuka Pintu")
            ...
            while time.time() - start_time < timeout:
                ...
                if stop_event.is_set():
                    return
                time.sleep(0.1)
            # Jika timeout habis dan tombol hijau belum ditekan
...
def identifikasi_sampah():
    while current_page == 3:
        ...
        elif io.input(pushbutton_putih) == io.HIGH:
            print("Membuka Pintu")
            set_servo_angle(pwmservo1, 180)
            start_time = time.time()
            timeout = 5
...
def kirim_data_ke_api(jumlah_sampah):
    global total_poin
    url = 'http://156.67.214.154/transaction.php'
    data = {
        'username': 'wena',
        'password': 'wena1234',
        'poin_change': jumlah_sampah
    }
...
def landing_page():
    ...
    label1 = Label(page_frame, text="SELAMAT DATANG DI\n REVERSE VENDING MACHINE", bd=2, bg="#88bc59", fg="black", font=("Tahoma", 16, "bold"), justify="center")
    ...
    ), fg="black", font=("Tahoma", 12), wraplength=950, pady=10, bg = "#ffffff",justify="left")
...
def langkah_1():
    ...
    label1 = Label(page_frame, text="LANGKAH 1\n SCAN KODE QR", fg="black", bg="#88bc59", bd=2, font=("Tahoma", 16, "bold"), justify="center")
    ...
    label2 = Label(page_frame, text=(
        ...
        "3. Setelah menekan tombol next, Anda diberi waktu 40 detik untuk memasukkan sampah"), fg="black", font=("Tahoma", 12), bg="#ffffff", wraplength=950, pady=10, justify="left")
...
def langkah_2():
    ...
    label1 = Label(page_frame, text = "LANGKAH 2\n MASUKKAN BOTOL", fg = "black", bg="#88bc59", font= ("Tahoma", 16, "bold"),bd = 2,justify="center")
    ...
    "4. Jika telah lewat 40 detik, maka pintu akan tertutup secara otomatis"), bg = "#ffffff", wraplength=950, fg= "black", font = ("Tahoma", 12), bd = 2,justify="left" )
...
def langkah_3():
    ...
    tombol_tambah = Button(page_frame, text="Tambah", activebackground="#FFFAFA", activeforeground="Black", font=("Tahoma", 12, "bold"), fg = "blue",bd=3, bg="#F5f5dc", justify="left")
    tombol_tambah.grid(column=1, row=3, columnspan=3, padx = 15, pady=150, ipadx=50)
    
def penutup(poin =100):
    global page_frame
    page_frame.grid_forget()
    ...
    label1 = Label(page_frame, text = "SELAMAT, ANDA BERHASIL!",bg ="#88bc59", fg = "black", font= ("Tahoma", 18, "bold"), justify="center")
    label1.grid(column = 0, row=1, columnspan=5, pady= 20, ipadx =20 ,padx = 300,sticky="nsew")

    label2 = Label(page_frame, text = "ANDA TELAH MENDAPATKAN POIN SEBESAR",fg = "black", font= ("Tahoma", 16), justify="center")
    label2.grid(column = 1, row= 2, ipadx = 20, padx= 250, pady = 10, sticky="nsew")

    label3 = Label(page_frame, text = f"Rp. {total_poin}", fg = "black" ,bg="#ffe14c",font= ("Tahoma", 16,"bold"), justify="center")
    ...
    label4 = Label(page_frame, text = (
        ...
        "SAMPAI JUMPA LAGI\n"
        "SEMOGA HARI ANDA MENYENANGKAN"), fg = "black" ,bg="#ffffff",font= ("Tahoma", 12,"italic"), justify="center")
