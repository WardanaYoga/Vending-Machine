...
def read_sensor():
    global channel, kondisi_sampah, label_kondisi_sampah
    ...
    if range_distance <= 200:
        print("Sampah Penuhh!!!")
        kondisi_sampah
        label_kondisi_sampah.config(text = f"Kondisi: {kondisi_sampah}")
        # Kosongkan list distances untuk pembacaan berikutnya
        distances.clear()
...
def landing_page():
    ...
    label_kondisi_sampah = Label(page_frame, text="Sampah Dalam Kondisi = ", fg = "black", font=("Tahoma", 12, "bold"), justify = "left")
    label_kondisi_sampah.grid(column = 1, row = 3, columnspan=3, pady = 20)
